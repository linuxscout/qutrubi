...
public class Modari3_marfou3_majhol {
	
	public Modari3_marfou3_majhol(Cursor c,List a){
		travail(c,a);
	...
	public static String[] anti_antoma_antom_homa_hom(String pronom,String verbe){
		...
		if(pronom.equals("أنتِ")){
			...
			conj1[0]=f1;
			verbe_partager=verbe.split("");
			String vrb = verbe.substring(0, verbe_partager.length-3);
			pronom = "أنتما(مذكر) ";
			verbe_partager=verbe.split("");
			String verbe1 = verbe.substring(0, verbe_partager.length-5);
			if(vrb.endsWith("ْ")){
				verbe1=verbe1+"َ"+"يَ"+"ا"+"ن"+"ِ";
			}else{
				verbe1=verbe1+"َ"+"ا"+"ن"+"ِ";}
			...
			pronom = "أنتم ";
			verbe_partager=verbe.split("");
			String verbe2 = verbe.substring(0, verbe_partager.length-5);
			if (verbe2.endsWith("و")){
				verbe2=verbe2+"ن"+"َ";
			}else{
				if(vrb.endsWith("ْ")){
					verbe2=verbe2+"ُ"+"و"+"ْ"+"ن"+"َ";
				}else{
					verbe2=verbe2+"ُ"+"و"+"ن"+"َ";}
			}
			...
			pronom = "هما(مذكر) ";
			verbe_partager=verbe.split("");
			String verbe3 = verbe.substring(1, verbe_partager.length-5);
			if(vrb.endsWith("ْ")){
				verbe3="ي"+verbe3+"َ"+"يَ"+"ا"+"ن"+"ِ";
			}else{
				verbe3="ي"+verbe3+"َ"+"ا"+"ن"+"ِ";}
			...
			pronom = "هما(مؤنث) ";
			verbe_partager=verbe.split("");
			String verbe4 = verbe.substring(1, verbe_partager.length-5);
			if(vrb.endsWith("ْ")){
				verbe4="ت"+verbe4+"َ"+"يَ"+"ا"+"ن"+"ِ";
			}else{
				verbe4="ت"+verbe4+"َ"+"ا"+"ن"+"ِ";}
			String f6=pronom +"\t\t" +verbe4;
			conj1[5]=f6;

			pronom = "هم ";
			verbe_partager=verbe.split("");
			String verbe5 = verbe.substring(1, verbe_partager.length-5);
			if(verbe5.endsWith("و")){
				verbe5="ي"+verbe5+"ن"+"َ";
			}else{
				if(vrb.endsWith("ْ")){
					verbe5="ي"+verbe5+"ُ"+"و"+"ْ"+"ن"+"َ";
				}else{
					verbe5="ي"+verbe5+"ُ"+"و"+"ن"+"َ";
				}
			}
