...
public class Modari3_ma3lom_majzom {

	public Modari3_ma3lom_majzom(Cursor c, List a){
travail(c,a);
	}
	 ...
	 public static String[] anta_ana_anahno_howa_hiya(String pronom,String verbe){
	   ...
	   public static String[] anti_antoma_antom_homa_hom(String pronom,String verbe){
		   ...
		   if(pronom.equals("أنتِ")){
               ...
               conj1[0]=f1;
	              verbe_partager=verbe.split("");
	              String vrb = verbe.substring(0, verbe_partager.length-2);
	          pronom = "أنتما(مذكر) ";
	              verbe_partager=verbe.split("");
	              String verbe1 = verbe.substring(0, verbe_partager.length-4);
	              if(vrb.endsWith("ْ")){
	            	  verbe1=verbe1+"َ"+"يَ"+"ا";
	              }else{
	            	  if(delet_techkil(verbe).length()-1 == 4){
	            		  verbe1=verbe1+"ُ"+"وَ"+"ا";  
	            	  }else{
	               verbe1=verbe1+"َ"+"ا";}
	              }
	           ...
	           pronom = "أنتم ";
	              verbe_partager=verbe.split("");
	              String verbe2 = verbe.substring(0, verbe_partager.length-4);
               ...
               conj1[3]=f4;
		        ...
		        pronom = "هما(مذكر) ";
			       verbe_partager=verbe.split("");
			        String verbe3 = verbe.substring(1, verbe_partager.length-4);
			        if(vrb.endsWith("ْ")){
			        	verbe3="ي"+verbe3+"َ"+"يَ"+"ا";
			        }else{
			        	if(delet_techkil(verbe).length()-1 == 4){
			        		verbe3="ي"+verbe3+"ُ"+"وَ"+"ا";
			        	}
			        	else{
			         verbe3="ي"+verbe3+"َ"+"ا";}
			        }
               ...
               conj1[4]=f5;
				 ...
				 pronom = "هما(مؤنث) ";
				       verbe_partager=verbe.split("");
				        String verbe4 = verbe.substring(1, verbe_partager.length-4);
				        if(vrb.endsWith("ْ")){
				        	verbe4="ت"+verbe4+"َ"+"يَ"+"ا";
				        }else{
				        	if(delet_techkil(verbe).length()-1 == 4){
				        		verbe4="ت"+verbe4+"ُ"+"وَ"+"ا";
				        	}
				        	else{
				         verbe4="ت"+verbe4+"َ"+"ا";}
				        }
              ...
              pronom = "هم ";
					       verbe_partager=verbe.split("");
					        String verbe5 = verbe.substring(1, verbe_partager.length-4);
